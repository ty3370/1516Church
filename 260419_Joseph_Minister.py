    ...
    if st.button("활동 시작하기"):
        if church and dept and students:
            ...
            full_prompt = (
                ...
                f"교회 이름은 {church}, 학생 이름은 {students}입니다. 학생이 여러 명일 수 있습니다. 대화 시 다정하게 학생(들)의 이름을 부르며 대화해 주세요. 성과 이름을 구분하지 말고 제시된 이름 그대로 부르세요."
                "공과 제목은 '요셉을 인도하시는 분은 누구일까요?'이고, 본문은 창세기 45장 1-8절입니다. 이 내용을 중심으로 인터뷰에 응해 주세요."
